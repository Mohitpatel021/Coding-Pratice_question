...
//********This is work only in sorted Linked List***********
...
//**************This is also work in Unsorted/Sorted Linked List**********
//***************Using Unordered Map ***************
...
//***********This will work only  in sorted Linked List***********
...
int main()
{
    ...
    insertAtPositon(head, tail, 3, 20);
    insertAtPositon(head, tail, 4, 30);
