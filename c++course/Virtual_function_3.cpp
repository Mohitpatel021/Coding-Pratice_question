...
public:
    ...
    void display()
    {
        ...
        cout << "Rating: " << rating << " out og 5 star" << endl;
...
2. They are accessed by virtual function
3. Virtual function can be a friend of another class
4. A virtual function in base class might not be used.
5. If a  virtual function defined in the base class, their is no necessity of redefine it in the derived class
*/